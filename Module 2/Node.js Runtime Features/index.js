...
// YOUR EXPLANATION:
// fs.readFile loads the whole file into memory at once, so memory usage increases
// as the file size increases. A stream moves the file in smaller chunks, so it
// does not keep the entire file in memory and peak memory stays roughly flat.
